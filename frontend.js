...
function setup(ctx) {
  ...
  const draftPolishState = new Map;
...
(() => {
  ...
  function finishDraftPolish(messageId, status, message) {
  ...
  function applyState(state) {
    ...
    personaBadge.textContent = personaError ? `Active persona unavailable: ${personaError}` : persona ? `Active persona: ${persona.name}${persona.title ? ` — ${persona.title}` : ""}` : "Active persona: none";
